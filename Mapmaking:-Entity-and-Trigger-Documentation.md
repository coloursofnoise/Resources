...
### Cassette Blocks:
These blocks pop in and out of the background into solid blocks to the tempo of the music. Any entity attached to it will appear and disappear with the block. There are 4 colors available, two of which are Everest inclusions. The order for appearance is: Pink, Blue, Green, and Marigold. Any default spikes attached to them will become the color of the block they are attached to. If two blocks of the same color are next to each other, their hitboxes will "merge". If the player jumps on a Cassette Block as it pops in, they will jump even higher than normal.
### Dash Blocks:
